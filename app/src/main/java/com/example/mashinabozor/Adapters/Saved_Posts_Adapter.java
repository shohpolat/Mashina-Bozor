...
public class Saved_Posts_Adapter extends RecyclerView.Adapter<Saved_Posts_Adapter.ViewHolder> {

    private ArrayList<Post> posts;
    private onClickListener listener;

    public Saved_Posts_Adapter() {
    ...
    public void refReshPosts() {
        posts.clear();
        String path = "saved_posts" + "/" + FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.bookmark.setImageResource(R.drawable.ic_delete_grey);
    ...
    public interface onClickListener {
        ...
        void onBookmarkClick(Post post, long position);
    }

    public void setOnClickListener(Saved_Posts_Adapter.onClickListener listener) {
