...
import com.example.mashinabozor.Veiws.MyPostsPage;
...
public class MyPostsAdapter extends RecyclerView.Adapter<MyPostsAdapter.ViewHolder> {
    ...
    MyPostsAdapter.onClickListener listener;
    ...
    public void refResh() {
        posts.clear();
        String path = "posts" + "/" + FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber();
    ...
    public void setOnClickListener(MyPostsAdapter.onClickListener listener) {
